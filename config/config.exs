...
config :user_service, :pow,
  ...
  # TODO: Document: PowTotp MUST come before PowPersistentSession
  extensions: [PowResetPassword, PowEmailConfirmation, PowTotp, PowPersistentSession],
  ...
  totp_encryption_secret: "ApIdbUfEY3ik4sHsvKfUw+adl60DmsF8Ysmey8z6lIyf2b27RYxGDSavSCpDyKjO",
